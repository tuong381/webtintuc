                            ...
                            <div class="col padding-0">
                                <div class="item d-flex">
                                    ...
                                    <div class="contact-content">
                                        ...
                                        <p style=" font-size: 20px; font-family: 'Flaticon';"> Địa chỉ: Số 1A Trần Khánh Dư, Xuân Khánh, Ninh Kiều, Cần Thơ .</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col padding-0">
                            ...
                            <div class="col padding-0">
                                <div class="item d-flex last">
                                    ...
                                    <div class="item-right">
                                        ...
                                        <p style="font-size: 20px;  font-family: 'Flaticon';">&emsp; ĐT: 0913.617.187
                                            <br>&emsp; Email: thanhdinhcantho@gmail.com</p>
                                        <p style="font-size: 20px;  font-family: 'Flaticon';"> - Nguyễn Thu Hà - Thư ký </p>
                                        <p style="font-size: 20px;  font-family: 'Flaticon';">&emsp; ĐT: 0907 981 060
                                            <br>&emsp; Email: ha0902017686@gmail.com</p>
                                    </div>
                                </div>
                            </div>
