        ...
        <div class="breadcrumbs_wrapper">
            ...
            <div class="breadcrumbs-container text-center">
                <ul class="breadcrumbs primary-font">
                    ...
                    <li><span style="font-family: 'FontAwesome';">Cửa hàng</span>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-lg-9 col-md-12 product-default-item">
                <div class="title-default custom-counter d-flex justify-content-between w-100 flex-wrap">
                    ...
                    <div class="content-right d-flex align-items-center justify-content-end">
                        <div class="list-grid mg-lf-0">
                            <div class="product-counter" style="margin-bottom: 2rem">Hiển thị <span class="color-default">1 - 9 </span>sản phẩm</div>
                        </div>
                    </div>
                </div>
                <div class="feature-products tab-content">
                    ...
                    <div id="grid" class="tab-pane active">
                        <div class="product">
                            <div class="row">
                                @foreach($sanpham_id as $key=>$hienthi_SP)
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    <div class="item item-hover-view-cart">
                                        <form action="{{URL::to('/them-gio-hang')}}" method="POST">
                                            {{csrf_field()}}
                                            <input type="hidden" name="idSP_hidden" value="{{$hienthi_SP->id_SanPham}}">
                                            <input type="hidden" name="soluong" value="1">
                                            <div class="product-thumb">
                                                <div class="product-container item-img">
                                                    <div class="product-image-container"><a class="product-img-link" href="{{URL::to('chi-tiet-san-pham/'.$hienthi_SP->id_SanPham)}}" title=""><img class="img-fluid" src="{{URL::to('public/upload/sanpham/'.$hienthi_SP->HinhAnh)}}" alt="img" style="height: 200px"><img class="img-fluid img-hover" src="{{URL::to('public/upload/sanpham/'.$hienthi_SP->HinhAnh)}}" alt="img" style="height: 200px">
                                                                </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="product-info text-center" style="height: 6rem">
                                                <h4 class="product-name"><a href="{{URL::to('chi-tiet-san-pham/'.$hienthi_SP->id_SanPham)}}">{{$hienthi_SP->TenSanPham}}</a></h4>
                                                <div class="price"><span>{{number_format($hienthi_SP->Gia)}} vnđ</span>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                ...
                <div style="margin-left: 21rem">
                   {{ $sanpham_id->links("pagination::bootstrap-4") }}
