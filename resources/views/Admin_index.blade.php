    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
             <a class="sidebar-brand brand-logo" style="color: white; text-align: center;">ADMIN</a>
          <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="{{asset('public/backend/images/logo-mini.svg')}}" alt="logo" /></a>
        </div>
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Loại điểm tin</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{URL::to('/admin-them-LoaiDT')}}">Thêm</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{URL::to('/admin-lietke-LoaiDT')}}">Liệt kê</a></li>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="News">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.html">Thêm</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns.html">Liệt kê</a></li>
               {{--  <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Typography</a></li> --}}
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="pages/tables/basic-table.html">
              ...
              <span class="menu-title">Chuyên mục pháp luật</span>
            </a>
          </li>
          <li class="nav-item menu-items">
