...
<div class="container-fluid" style=" background: #fff;width: 55rem;  margin-top: 5rem;">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            font-family: 'Font Awesome 5 Free'; font-size: 35px;">Thêm Nhân Viên </h1>
          ...
          {{--      <input type="hidden" name="id_AD"> --}}
              ...
              <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">
                    ...
                    <input name="HoTenAD" type="text" required="required" style="font-size: 1rem; width: 100%" class="form-control form-control-user"  placeholder="Nhập tên nhân viên">
              ...
              <div class="row form-group">
                  <div class="col-lg-6 col-md-6 form-group">
                    ...
                    <input name="SoDT" type="text" required="required" style="font-size: 1rem; width: 100%" class="form-control form-control-user"  placeholder="Nhập số điện thoại">
